...
import Data.Product.Properties as Product using (≡-dec)
import Data.Word.Properties as Word       using (_≟_)
...
_≈?_ : Decidable _≈_
_≈?_ = decidable toWords _≡_ (Product.≡-dec Word._≟_ Word._≟_)
